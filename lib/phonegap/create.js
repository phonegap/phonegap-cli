...
module.exports = {
    create: function(phonegap) {
        console.log('*** phonegap create.js');
        return new CreateCommand(phonegap);
    }
};

function CreateCommand(phonegap) {
    console.log('*** phoengap CreateCommand');
    console.log(this);
...
CreateCommand.prototype.run = function(options, callback) {
    console.log('*** phonegap CreateCommand run');
    // require options
...
CreateCommand.prototype.execute = function(options, callback) {
    console.log('*** phonegap CreateCommand execute');
    var self = this;
    ...
    console.log('*** creating cordova command');
