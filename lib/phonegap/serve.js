...
var Command = require('./util/command'),
    //cordova = require('../cordova').cordova, // ToDo: @carynbear cordova dependence on cordova.prepare()... see cordova-lib/src/cordova/prepare.js;
...
AppCommand.prototype.execute = function(options, callback) {
    ...
    // ToDo: @carynbear decoupled by shelling out
    ...
    var cordovaCommand = 'cordova prepare';
