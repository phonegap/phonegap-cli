...
LocalBuildCommand.prototype.execute = function(options, callback) {
    ...
    module.exports.addPlatform.call(self, options, function(e) {
        ...
        try {
            ...
            // build the platform
            cordova.build([ platform.local ], function() {
...
module.exports.addPlatform = function(options, callback) {
    ...
    try {
        // add the platform
        cordova.platform('add', [ platform.local ], function() {
            callback(null);
        });
    }
    catch(e) {
...
cordova.on('after_prepare', function(data, done) {
    var projectPath = path.join('.', 'platforms', _platform.local),
        parser = new cordova.platform[_platform.local].parser(projectPath),
        cordovaFile = path.join(parser.www_dir(), 'cordova.js'),
        phonegapFile = path.join(parser.www_dir(), 'phonegap.js');

    // create phonegap.js
    shell.cp(cordovaFile, phonegapFile);
