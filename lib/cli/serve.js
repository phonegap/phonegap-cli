...
module.exports = function(argv, callback) {
    ...
    var startWatchandServe = function() {
        ...
        // add new browser if it does not exist already
    // if (argv.browser) {
    //     console.log('added browser');
    //     addBrowser(startWatchandServe);
    
    // } else {
    //     startServing(data, callback);
    // }
